...
@login.user_loader   # flask login uses this function to reload the user object from the user ID stored in the session
...
def login():
    ...
    if username in usersdb and password == usersdb[username]:
        login_user(User(username)) # salva nella session lo user che ha fatto login
        if not next_page:
            next_page = '/main'
